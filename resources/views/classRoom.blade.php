    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            table= $('#typeTable').DataTable({
                "responsive": true,
                "autoWidth":false,
                //"sAjaxSource":"{{route('classRooms.index",
                "sAjaxDataProp":"data",
                "oLanguage": {
            ...
            //FONCTION ADD DEVIS
            $("#btnAddClasseId").on('click', function(){
                $(".text-danger").remove();
                $(".col-md-4").removeClass('has-error').removeClass('has-success');
                    ...
                    $.ajax({
                        ...
                        if(jqXHR.responseJSON.errors.name !==undefined){
                             $("#nameId").after('<p class="text-danger">'+jqXHR.responseJSON.errors.name+'</p>');
                              ...
                              if(jqXHR.responseJSON.errors.scolarite !==undefined){
                                        $("#scolariteId").after('<p class="text-danger">'+jqXHR.responseJSON.errors.scolarite+'</p>');
                                        } 
            ...
            if(id) {
                ...
                $.ajax({
                    ...
                    success:function(response) {
                        ...
                        $("#editScolariteId").val(response.scolarite);

                        $("#editClasseForm").append('<input type="hidden" name="id" id="Classe_edit_id" value="'+response.id+'"/>');
                        // here update the member data
                        $("#btnUpdateClasseId").unbind('click').bind('click', function(){

                            // remove error messages
                            $(".text-danger").remove();
                        
                                var idClasse =$("#Classe_edit_id").val();
                                $.ajax({
                                    url:"/classRooms/"+idClasse,
                                    type:'PUT',
                                    data:$("#editClasseForm").serialize(),
                                    dataType :"json",
                                     beforeSend: function() {
                                     $('#editLoadingId').show();
                                     },
                                    ...
                                    console.log(jqXHR);
                                      if(jqXHR.responseJSON.errors.name !==undefined){
                                        ...
                                        if(jqXHR.responseJSON.errors.scolarite !==undefined){
                                        $("#editScolariteId").after('<p class="text-danger">'+jqXHR.responseJSON.errors.scolarite+'</p>');
                                        } 
                    ...
                    $.ajax({
                        ...
                        success:function(response) {
                            if(response.status === true) {
                                ...
                                table.ajax.reload(null, false);
                                // close the modal
                                $("#removeClassRoomModal").modal('hide');
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <button class="btn btn-success" data-toggle="modal" data-target="#addClasseModal" id="btnAddNew"><i class="fa fa-plus"></i>Ajouter</button>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
...
<!-- ./wrapper -->
<!-- Add product Modal-->
<div class="modal fade" id="addClasseModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!--FORMULIARE-->
                <form id="ClasseForm" autocomplete="off">
                  ...
                  <div id="loadingId">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label class="control-label col-md-12">Scolarité</label>
                        <div class="col-md-12">
                            <input name="scolarite" id="scolariteId" class="form-control" type="text">
                            <span class="help-block"></span>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-success" id="btnAddClasseId" type="submit"><i class="fa fa-check"></i>Enregistrer</button>
...
<!-- Edit product Modal-->
<div class="modal fade" id="editClassRoomModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <!--FORMULIARE-->
                <form id="editClasseForm" autocomplete="off">
                      {{csrf_field()}}
                 <div id="editLoadingId">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-12">Scolarité</label>
                        <div class="col-md-12">
                            <input name="scolarite" id="editScolariteId" class="form-control" type="text">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-footer">
                <button class="btn btn-success" id="btnUpdateClasseId" type="submit"><i class="fa fa-check"></i>Enregistrer</button>
                <button class="btn btn-danger" type="button" data-dismiss="modal">Annuler</button>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="removeClassRoomModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
