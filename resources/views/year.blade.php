...
#editLoadingId {
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            //FONCTION ADD DEVIS
            $("#btnAddshoolYearId").on('click', function(){
                $(".text-danger").remove();
                $(".col-md-4").removeClass('has-error').removeClass('has-success');
            ...
            if(id) {
                ...
                $.ajax({
                    ...
                    success:function(response) {
                        ...
                        $("#editStartId").val(response.start_year);
                        $("#editEndId").val(response.end_year);
                        $("#editDescriptionId").val(response.description);
                        if(response.status==1){
                            $("#editStatutId").html('');
                           $("#editStatutId").append(' <option value="1">Actif</option>');
                            $("#editStatutId").append('<option value="2">inactif</option>'); 
                        }else{
                            $("#editStatutId").html('');
                            $("#editStatutId").append('<option value="2">inactif</option>');
                            $("#editStatutId").append(' <option value="1">Actif</option>');
                        ...
                        $("#editshoolYearForm").append('<input type="hidden" name="id" id="schoolYear_edit_id" value="'+response.id+'"/>');
                        // here update the member data
                        $("#btnUpdateshoolYearId").unbind('click').bind('click', function(){

                            // remove error messages
                            $(".text-danger").remove();
                        
                                var idshoolYear =$("#schoolYear_edit_id").val();
                                $.ajax({
                                    url:"/schoolYears/"+idshoolYear,
                                    type:'PUT',
                    ...
                    $.ajax({
                        ...
                        success:function(response) {
                            if(response.status === true) {
                                ...
                                table.ajax.reload(null, false);
                                // close the modal
                                $("#removeSchoolYearModal").modal('hide');
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <button class="btn btn-success" data-toggle="modal" data-target="#addshoolYearModal" id="btnAddNew"><i class="fa fa-plus"></i>Ajouter</button>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
...
<!-- ./wrapper -->
<!-- Add product Modal-->
<div class="modal fade" id="addshoolYearModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">
                    NOUVELLE ANNEE SCOLAIRE</h5>
            ...
            <div class="modal-body">
                <!--FORMULIARE-->
                <form id="shoolYearForm" autocomplete="off">
                  ...
                  <div id="loadingId">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input name="name" id="nameId" class="form-control" type="text" data-inputmask='"mask": "9999-9999"' data-mask>
                            <span class="help-block"></span>
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <label class="control-label col-md-12">Debut</label>
                        <div class="col-md-12">
                            <input name="start_year" id="startId" class="form-control" type="text">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <label class="control-label col-md-12">Fin</label>
                        <div class="col-md-12">
                            <input name="end_year" id="endId" class="form-control" type="text">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-footer">
                <button class="btn btn-success" id="btnAddshoolYearId" type="submit"><i class="fa fa-check"></i>Enregistrer</button>
...
<div class="modal fade" id="editSchoolYearModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
                ...
                <form id="editshoolYearForm" autocomplete="off">
                  ...
                  <div id="editLoadingId">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-12">Année Scolaire</label>
                        <div class="col-md-12">
                            <input name="name" id="editNameId" class="form-control" type="text" data-inputmask='"mask": "9999-9999"' data-mask>
                            <span class="help-block"></span>
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        <label class="control-label col-md-12">Debut</label>
                        <div class="col-md-12">
                            <input name="start_year" id="editStartId" class="form-control" type="text">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-12">Fin</label>
                        <div class="col-md-12">
                            <input name="end_year" id="editEndId" class="form-control" type="text">
                            <span class="help-block"></span>
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="form-control select2" id="editStatutId" name="status">
                                </select>
                                <span class="help-block"></span>
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-success" id="btnUpdateshoolYearId" type="submit"><i class="fa fa-check"></i>Enregistrer</button>
                <button class="btn btn-danger" type="button" data-dismiss="modal">Annuler</button>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="removeSchoolYearModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">

            <div class="modal-header">
                <h4 class="modal-title" id="defaultModalLabel">
                    SUPPRIMER ANNEE SCOLAIRE</h4>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
